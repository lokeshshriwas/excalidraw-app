    ...
    <div className="min-h-screen bg-[#0d0d0d] flex items-start justify-center px-4 py-8">
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-white mb-2">Your Rooms</h1>
          <p className="text-gray-400 text-sm">Start building</p>
        </div>
                        ...
                        <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 4v10a1 1 0 001 1h8a1 1 0 001-1V8M9 8h6"
                            />
                          </svg>
                        </div>
                        <div>
