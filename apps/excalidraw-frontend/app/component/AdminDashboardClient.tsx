...
const AdminDashboardClient: React.FC = () => {
  ...
  const handleJoinRequest = async (
    ...
    try {
      await axios.patch(
        `${BASE_URL}/req/requests/${requestId}/handle`,
        { action },
        { headers: { Authorization: `${token}` } },
      );
                            ...
                            <span className="text-green-400 text-sm flex items-center">
                              ...
                              >
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth={2}
                                  d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 0a2.5 2.5 0 01-2.5 2.5 2.5 2.5 0 01-2.5-2.5 2.5 2.5 0 012.5-2.5 2.5 2.5 0 012.5 2.5z"
                                />
                              </svg>
                      ...
                      <div className="space-y-2">
                        {selectedRoom.users.map((user) => (
                          ...
                          >
                            ...
                            <button
                              onClick={() =>
                                removeUserFromRoom(selectedRoom.id, user.id)
                              }
                              disabled={redirecting}
